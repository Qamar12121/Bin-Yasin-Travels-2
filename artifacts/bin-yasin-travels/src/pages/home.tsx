          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { name: "Malaysia Visit Visa", desc: "Single / Multiple Entry", price: "PKR 18,000", img: "/images/dest-istanbul.png" },
                { name: "Kuwait Visit Visa", desc: "Single / Multiple Entry", price: "PKR 22,000", img: "/images/dest-madinah.png" },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-3 mb-5">
                <a href="https://www.facebook.com/share/1Juofk3DoD/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary transition-colors">
                ...
                <a href="https://www.instagram.com/invites/contact/?utm_source=ig_contact_invite&utm_medium=copy_link&utm_content=hqb78g" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary transition-colors">
